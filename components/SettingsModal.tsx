    ...
    >
        ...
        >
            <div className="p-6 border-b border-gray-700">
                <h2 className="text-xl font-bold text-gray-100">AI Provider Settings</h2>
                <p className="text-sm text-gray-400 mt-1">Choose the AI model used for network analysis.</p>
            </div>
